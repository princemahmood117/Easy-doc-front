  ...
  return (
    <div>
      ...
      {docInfo ? (
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex-1 border border-gray-300 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0">
            ...
            <div>
              <p className="flex items-center  font-medium text-gray-500 mt-4 gap-2">
                About <img src={assets.info_icon} alt="" />
              </p>
              <p className="mt-1 text-gray-600 max-w-[700px]">
                {docInfo.about}
              </p>
            </div>
        ...
        </p> // Display a loading state until `docInfo` is populated
      )}
      ...
      <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-500">
        ...
        <button className="btn btn-wide bg-blue-300 mt-4 hover:bg-blue-500">
          Book an appointment
        </button>
      </div>
